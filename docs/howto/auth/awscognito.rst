...
able to configure the instance automatically, replace relevant placeholders::
        ...
        #!/bin/bash
        ##############################################
        # Need to ensure oauthenticator is bumped to at least 0.10.0
        ##############################################
...
Assuming tljh has already been installed, we need to make sure the oauthenticator module is at least 0.10.0 and if not
